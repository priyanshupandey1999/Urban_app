    ...
    return (
        <div className="content">
            ...
            <div className="arrow-icons">
                <img src={back_arrow} className="back-arrow" alt="back_arrow" />
                <img src={next_arrow} className="next-arrow" alt="next_arrow" />
            </div>
            <img src={feature_image} className="feature-image" alt="img" />
        </div>
    )
}
